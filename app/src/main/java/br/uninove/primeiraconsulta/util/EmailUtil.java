...
public class EmailUtil {
    ...
    public static String getEmail(Prontuario prontuario, EstiloDeVida estiloDeVida, ExameFisico exameFisico, Anamnese anamnese, List<ListaProblemas> listaProblemas) {
        String email;
