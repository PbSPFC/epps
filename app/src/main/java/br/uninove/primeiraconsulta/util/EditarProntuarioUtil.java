...
public class EditarProntuarioUtil {


    public static Prontuario getEditarProntuario(Prontuario prontuario, EditText edIdade, EditText edPeso, EditText edAltura) throws Exception {
        try {
    ...
    public static ExameFisico getEditarExameFisico(ExameFisico exameFisico, EditText edSistole, EditText edDiastole, Prontuario prontuario, EditText edCervical, EditText edCintura, EditText edQuadril, EditText edSnellenDireita, EditText edSnellenEsquerda, EditText edExameComentario) throws Exception {

        try {
            if (!edSistole.getText().toString().isEmpty()) {
                exameFisico.setSistole(Integer.parseInt(edSistole.getText().toString()));
            }
            if (!edDiastole.getText().toString().isEmpty()) {
                exameFisico.setDiastole(Integer.parseInt(edDiastole.getText().toString()));
            }
            ...
            if (!edCervical.getText().toString().isEmpty()) {
                exameFisico.setCervical(Integer.parseInt(edCervical.getText().toString()));
            }
            ...
            if (!edCintura.getText().toString().isEmpty()) {
                exameFisico.setCintura(Integer.parseInt(edCintura.getText().toString()));
            }
            ...
            if (!edQuadril.getText().toString().isEmpty()) {
                exameFisico.setQuadril(Float.parseFloat(edQuadril.getText().toString()));
            }
            ...
            if (!edSnellenDireita.getText().toString().isEmpty()) {
                exameFisico.setSnellenDireita(Integer.parseInt(edSnellenDireita.getText().toString()));
            }
            if (!edSnellenEsquerda.getText().toString().isEmpty()) {
                exameFisico.setSnellenEsquerda(Integer.parseInt(edSnellenEsquerda.getText().toString()));
            }
    ...
    public static EstiloDeVida getEstiloDeVida(EstiloDeVida estiloDeVida, RadioGroup rgGordura, RadioGroup rgFibra, RadioGroup rgCalcio, RadioGroup rgSodio, RadioGroup rgAcucar, RadioGroup rgRefri, RadioGroup rgAgua, RadioGroup rgAtFisica, RadioGroup rgSonoOpt1, RadioGroup rgSonoOpt2, RadioGroup rgSonoOpt3, RadioGroup rgSonoOpt4, RadioGroup rgSonoOpt5, RadioGroup rgSonoOpt6, RadioGroup rgCigarroAtivo, RadioGroup rgCigarro1, RadioGroup rgCigarro2, RadioGroup rgCigarro3, RadioGroup rgCigarro4, RadioGroup rgCigarro5, RadioGroup rgCigarro6, RadioGroup rgAlcoolAtivo, RadioGroup rgAlcool1, RadioGroup rgAlcool2, RadioGroup rgAlcool3, RadioGroup rgAlcool4, RadioGroup rgSexualmenteAtivo) throws Exception {
        ...
        try {
            ...
            if (sexualmenteAtivo == R.id.rb_editar_sexualmente_ativo_sim) {
                estiloDeVida.setSexualmenteAtivoOpt(R.id.rb_editar_sexualmente_ativo_sim);
                estiloDeVida.setSexualmenteAtivo("Sim");
            } else if (sexualmenteAtivo == R.id.rb_editar_sexualmente_ativo_nao) {
    ...
    public static Anamnese getEditarAnamnese(Anamnese anamnese, EditText edQueixa, EditText edHistoriaDoenca, EditText edInterrogatorio, EditText edPercepcao) throws Exception {
