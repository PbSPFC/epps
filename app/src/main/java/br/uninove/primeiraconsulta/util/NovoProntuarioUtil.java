...
public class NovoProntuarioUtil {
    ...
    public static Prontuario getNovoProntuario(Prontuario prontuario, RadioGroup rgSexo, EditText edIdade, EditText edPeso, EditText edAltura) throws Exception {
    ...
    public static ExameFisico getNovoExameFisico(ExameFisico exameFisico, EditText edSistole, EditText edDiastole, Prontuario prontuario, EditText edCervical, EditText edCintura, EditText edQuadril, EditText edSnellenDireita, EditText edSnellenEsquerda, EditText edExameComentario) throws Exception {
    ...
    public static Anamnese getNovoAnamnese(Anamnese anamnese, EditText edQueixa, EditText edHistoriaDoenca, EditText edInterrogatorio, EditText edPercepcao) throws Exception {
